...
public class LoginGui extends javax.swing.JFrame {
    ...
    public LoginGui() {
        checkLogin.LoadUsers();
        logins = checkLogin.getUserPassList();
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String res = checkLogin.LoginCheck(username,password);
        if (res.equals("admin")){
            mainfram adminMain = new mainfram();
            adminMain.setVisible(true);
            this.dispose();
        }
        else if (res.equals("user")) {
            UserFram  userFram = new UserFram();
